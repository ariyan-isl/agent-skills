...
description: 'Develop React Router v7 applications with best practices. Use when: building routes with React Router v7, implementing loaders and actions, setting up type-safe routing, creating layout components, writing forms and navigation, or debugging routing issues.'
argument-hint: 'React Router v7 development task'
---

# React Router v7 Expert Guidance
...
Only setup `ErrorBoundary`s for routes if explicitly asked. All errors bubble up to the `ErrorBoundary` in `root.tsx` by default.
